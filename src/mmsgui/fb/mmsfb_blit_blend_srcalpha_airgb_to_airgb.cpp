...
void mmsfb_blit_blend_srcalpha_airgb_to_airgb(MMSFBExternalSurfaceBuffer *extbuf, int src_height, int sx, int sy, int sw, int sh,
	...
	// first time?
	static bool firsttime_mmsfb_blit_blend_srcalpha_airgb_to_airgb = true;
	if (firsttime_mmsfb_blit_blend_srcalpha_airgb_to_airgb) {
		printf("DISKO: Using accelerated blend srcalpha AiRGB to AiRGB.\n");
		firsttime_mmsfb_blit_blend_srcalpha_airgb_to_airgb = false;
	}
