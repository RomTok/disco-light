...
void MMSLabelWidgetClass::setColor(DFBColor color) {
    this->color = color;
    this->iscolor = true;
}
...
DFBColor MMSLabelWidgetClass::getColor() {
    return this->color;
}
...
void MMSLabelWidgetClass::setSelColor(DFBColor selcolor) {
...
DFBColor MMSLabelWidgetClass::getSelColor() {
