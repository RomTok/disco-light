...
#ifndef MMSSLIDERCLASS_H_
#define MMSSLIDERCLASS_H_
...
namespace MMSGUI_SLIDER_ATTR {
	...
	#define MMSGUI_SLIDER_ATTR_IDS \
		MMSGUI_SLIDER_ATTR_IDS_image, \
		MMSGUI_SLIDER_ATTR_IDS_image_path, \
		MMSGUI_SLIDER_ATTR_IDS_image_name, \
		MMSGUI_SLIDER_ATTR_IDS_selimage, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_path, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_name, \
		MMSGUI_SLIDER_ATTR_IDS_image_p, \
		MMSGUI_SLIDER_ATTR_IDS_image_p_path, \
		MMSGUI_SLIDER_ATTR_IDS_image_p_name, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_p, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_p_path, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_p_name, \
		MMSGUI_SLIDER_ATTR_IDS_image_i, \
		MMSGUI_SLIDER_ATTR_IDS_image_i_path, \
		MMSGUI_SLIDER_ATTR_IDS_image_i_name, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_i, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_i_path, \
		MMSGUI_SLIDER_ATTR_IDS_selimage_i_name, \
		MMSGUI_SLIDER_ATTR_IDS_position
	
	#define MMSGUI_SLIDER_ATTR_INIT { \
		MMSGUI_BASE_ATTR_ATTRDESC, \
		MMSGUI_BORDER_ATTR_ATTRDESC, \
		MMSGUI_WIDGET_ATTR_ATTRDESC, \
		MMSGUI_SLIDER_ATTR_ATTRDESC, \
	...
	typedef enum {
		...
		MMSGUI_SLIDER_ATTR_IDS
	} ids;
}

extern TAFF_ATTRDESC MMSGUI_SLIDER_ATTR_I[];


//! A data access class for the slider widget.
/*!
This class is the base for the MMSSlider widget class.
