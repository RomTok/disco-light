...
install-pkgconfig:
	...
	@echo "Libs: $(LDFLAGS) -L\$${libdir} -lmmsbase -lmmsconfig -lmmscore -lmmsgui -lmmsinput -lmmsmedia -lmmstools $(LIBXML_LIBS) $(SQLITE3_LIBS) $(FREETDS_LIBS) $(DIRECTFB_LIBS) $(XINE_LIBS) $(SIGC_LIBS) $(XINE_LIBS)" >> $(DESTDIR)$(libdir)/../pkgconfig/$(PROJECTNAME).pc 
